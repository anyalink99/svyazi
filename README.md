...
Браузерная версия Codenames, в которой ведущим и игроком могут быть семантические агенты. Проект **не использует LLM, облачные AI API и базу контекстно.рф**: вся логика работает на компактных русских эмбеддингах Navec, морфологии и явной функции риска.
